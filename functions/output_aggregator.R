...
files_sim <- c(list.files("fits/sim/fit_sim3", full.names = TRUE), list.files("fits/sim/fit_homo", full.names = TRUE), list.files("fits/sim/fit_het", full.names = TRUE))
...
Rhat_list <- vector("list", length(files))
